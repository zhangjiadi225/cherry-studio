...
export const PET_VRM_STAGE_DEFAULT_ANIMATION_PRESET: PetVrmStageAnimationPreset = 'vroid-show-full-body'
...
export function getPetVrmStageAnimationPresetUrl(preset: PetVrmStageAnimationPreset | undefined): string {
  return (
