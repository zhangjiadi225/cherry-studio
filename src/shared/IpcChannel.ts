export enum IpcChannel {
  ...
  // Pet
  Pet_ListPackages = 'pet:list-packages',
  Pet_GetSelectedPackage = 'pet:get-selected-package',
  Pet_SelectAndImportPackage = 'pet:select-and-import-package',
  Pet_SelectPackage = 'pet:select-package',
  Pet_DeletePackage = 'pet:delete-package',
  Pet_ListAssets = 'pet:assets:list',
  Pet_ImportAsset = 'pet:assets:import',
  Pet_ImportRemoteAsset = 'pet:assets:import-remote',
  Pet_DeleteAsset = 'pet:assets:delete',
  Pet_ResolveAsset = 'pet:assets:resolve',
  Pet_ListAnimals = 'pet:list-animals',
  Pet_UpsertAnimal = 'pet:upsert-animal',
  Pet_RemoveAnimal = 'pet:remove-animal',
  Pet_ReorderAnimals = 'pet:reorder-animals',
  Pet_GetPastureSnapshot = 'pet:get-pasture-snapshot',
  Pet_GetVrmStageConfig = 'pet:vrm:get-stage-config',
  Pet_SetVrmStageModelProfile = 'pet:vrm:set-stage-model-profile',
  Pet_DeleteVrmStageModelProfile = 'pet:vrm:delete-stage-model-profile',
  Pet_SetVrmStageSceneSettings = 'pet:vrm:set-stage-scene-settings',
  Pet_ResizePasture = 'pet:resize-pasture',
  Pet_DismissTaskBubble = 'pet:dismiss-task-bubble',
  Pet_DismissPermissionPrompt = 'pet:dismiss-permission-prompt',
  Pet_SetTaskBubbleHold = 'pet:set-task-bubble-hold',
  Pet_SendQuickReply = 'pet:send-quick-reply',
  Pet_OpenTask = 'pet:open-task',
  Pet_DispatchTaskCommand = 'pet:tasks:dispatch',
  Pet_Show = 'pet:show',
  Pet_Hide = 'pet:hide',
  Pet_Close = 'pet:close',
  Pet_GetWindowBounds = 'pet:get-window-bounds',
  Pet_ResizeWindow = 'pet:window:resize',
  Pet_MoveWindow = 'pet:move-window',
  Pet_SetMouseEventsIgnored = 'pet:set-mouse-events-ignored',
  Pet_StartMouseTracking = 'pet:start-mouse-tracking',
  Pet_StopMouseTracking = 'pet:stop-mouse-tracking',
  Pet_MouseStateChanged = 'pet:mouse-state-changed',
  Pet_StartDraggingWindow = 'pet:start-dragging-window',
  Pet_SetPin = 'pet:set-pin',
  Pet_PlayAnimation = 'pet:play-animation',
  Pet_ActivityChanged = 'pet:activity-changed',
  Pet_PackageChanged = 'pet:package-changed',
  Pet_PastureChanged = 'pet:pasture-changed',
  ...
  Ai_AgentPresentation_GetReplay = 'ai:agent-presentation:get-replay',
  Ai_AgentPresentation_Event = 'ai:agent-presentation:event',
